# `src/minipixels/math/types.ml`

[Home](README.md) · [Files](Files.md)

Provides minipixels math types facilities for this project.

Package: [`minipixels.math.types`](Package-minipixels-math-types-2130299542.md)
...
| Parameter | Type | Default | Description |
| --- | --- | --- | --- |
| `dst` | `dynamic` | — | dst value consumed by this operation. |
...
| --- | --- | --- | --- |
| `v` | `dynamic` | — | v value consumed by this operation. |
| `lo` | `dynamic` | — | lo value consumed by this operation. |
...
| --- | --- | --- | --- |
| `r` | `dynamic` | — | r value consumed by this operation. |
| `minValue` | `dynamic` | — | minValue value consumed by this operation. |
...
<a id="function-function-minipixels-math-types-timercreate-function-timercreate-seconds-repeat-src-minipixels-math-types-ml-710358436"></a>
### timerCreate
